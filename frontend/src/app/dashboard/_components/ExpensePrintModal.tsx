...
import { printExpensePDF } from '@/lib/pdf/generateExpensePDF';
import { cn } from '@/lib/utils';
import { getExpenseReport } from '@/services/analytics';
...
export function ExpensePrintModal({
  open,
  onOpenChange,
  defaultYear,
  defaultMonth,
  onPrint,
}: ExpensePrintModalProps) {
  ...
  const handlePrint = async () => {
    ...
    try {
      ...
      const data = await getExpenseReport(startDateStr, endDateStr, {
      ...
      printExpensePDF(startDate, endDate, data);
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Select the start and end date for the expense report you want to print.
            </DialogDescription>
          </DialogHeader>
...
export function ExpensePrintModalTrigger({
  children,
  className,
  onClick,
}: {
